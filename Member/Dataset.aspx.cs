...
namespace medicalProject.Member
{
    public partial class Dataset : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                medicalProject.JQueryUtils.RegisterTextBoxForDatePicker(Page, txtDate);
        ...
        private void loadDataset()
        {
            try
            {
                ...
                tab = obj.GetDataByInchargerId(Session["ICId"].ToString());
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (btnSubmit.Text.Equals("Upload"))
            {
                try
                {
                    obj.InsertData(Session["ICId"].ToString(), DateTime.Parse(txtDate.Text), txtData.Text);
            ...
            else if (btnSubmit.Text.Equals("Update"))
            {
                ...
                try
                {
                    obj.UpdateData(Session["ICId"].ToString(), DateTime.Parse(txtDate.Text), txtData.Text, int.Parse(Session["datasetId"].ToString()));
